  ...
  return (
    <div className="h-fit bg-zinc-800 py-6 flex justify-center">
      <div className="character-container h-max w-3/4 flex flex-row flex-wrap 
          justify-between max-[480px]:bg-blue-400 max-[480px]:flex-col max-[480px]:justify-center">
        <article className="bg-[#3C3E44] h-48 w-5/12 rounded-lg m-2 flex max-[800px]:h-fit max-[480px]:flex-col max-[480px]:w-9/12">
        ...
        <article className="bg-[#3C3E44] h-48 w-5/12 rounded-lg m-2 flex">
          ...
          <div id="content-wrapper" className=" w-3/5 rounded-r-lg px-6 py-2">
            <div className="mb-2.5">
              <p className="text-zinc-100">Beth Smith</p>
